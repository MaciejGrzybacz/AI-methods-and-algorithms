...
def create_problem_model(options):
    ...
    problem_name = get_or_prompt_if_not_exists_or_invalid(
        config,
        "name",
        {
    ...
    benchmark_file = get_or_prompt_if_not_exists_or_invalid(
        config,
        "benchmark",
        {
    ...
    default_move_generator_name = get_or_prompt_if_not_exists_or_invalid(
        config,
        "move_generator",
        {
    ...
    default_goal_name = get_or_prompt_if_not_exists_or_invalid(
        config,
        "goal",
        {
